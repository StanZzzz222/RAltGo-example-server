...
import (
	...
	"github.com/StanZzzz222/RAltGo/common/core/alt/alt_blip"
	"github.com/StanZzzz222/RAltGo/common/core/alt/alt_ped"
...
*/
func Benchmark() {
	ped1 := alt_ped.CreatePedByHash(ped_hash.Abner, common.NewVector3(-1019.3187, -2928.9758, 14), common.NewVector3(0, 0, 0))
	start := time.Now()
	for i := 0; i < 50000; i++ {
